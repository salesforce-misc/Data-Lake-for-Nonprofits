...
function createDashboardJson(region: string, workflowArn: string, clusterName: string, workGroup: string, athenaDataBucketName: string, importDataBucketName: string, importAlarmArns: string[]) {
  return JSON.stringify(
    {
      ...
      "widgets": [
          ...
          },
          {
              ...
              "type": "text",
              "properties": {
                  "markdown": "AppFlow will use S3 for temporary storage while the data is waiting to be ingested into RDS. This storage is setup to automatically expire the next day so should clean itself up automatically and not incur a lot of storage charges."
              }
          },
          {
              "height": 4,
