...
import { Box, Heading, Text, HStack, Button, Link as ChakraLink, UnorderedList, ListItem, Stack, Collapse, Divider } from "@chakra-ui/react";
    ...
    >
      <Box borderRadius="lg" boxShadow="base" bg="blue.50" mt={4} p={8}>
        ...
        <Box p={0}>
          ...
          <Text mb={4}>
            Amazon AppFlow is a service that allows AWS to connect to Salesforce, for this to work, you need to create a Salesforce connection using
            Amazon AppFlow.
          </Text>
        </Box>
        ...
        <Stack direction={{ base: "column", md: "row" }} spacing="30px" pt={3} pb={6} mt={3}>
          ...
          <Box>
            <UnorderedList ml={5} mt={2} mb={3} color="blue.800">
              ...
              <ListItem>
                You will be directed back to the AppFlow connections page, you should see the connection name that you just created. You don't need to
                do anything else on the AppFlow connections page. Go ahead and select Yes for the next question.
              </ListItem>
            </UnorderedList>
          </Box>
        </Stack>
