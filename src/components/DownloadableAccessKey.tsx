    ...
    return (
      <Box fontSize="sm">
        <Alert status="success" colorScheme={colorScheme} mb={4} mt={4} borderRadius="md">
          <Box>
            <AlertDescription>
              This is your <span style={{ fontWeight: "bold" }}>ONLY</span> chance to download and view the secret access key for this user. You
              cannot recover the secret access key later. However, you can create new access keys at any time by first deleting the existing ones and
              creating new ones.
            </AlertDescription>
            <Box textAlign="right">
